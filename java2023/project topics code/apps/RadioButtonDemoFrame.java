 ...
 * @author SCALive
 */
public class RadioButtonDemoFrame extends javax.swing.JFrame {

    /**
     * Creates new form RadioButtonDemoFrame
     */
    public RadioButtonDemoFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RadioButtonDemoFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RadioButtonDemoFrame().setVisible(true);
            }
        });
    }
